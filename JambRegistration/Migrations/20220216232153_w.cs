        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySQL:ValueGenerationStrategy", MySQLValueGenerationStrategy.IdentityColumn),
                    ExaminationDate = table.Column<string>(type: "text", nullable: true),
                    CenterID = table.Column<int>(type: "int", nullable: false),
                    CourseFirstChoice = table.Column<string>(type: "text", nullable: true),
                    CourseSecondChoice = table.Column<string>(type: "text", nullable: true),
                    SchoolFirstChoice = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SchoolCourses_Schools_SchoolsID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SchoolCourses_SchoolsID",
                table: "SchoolCourses",
                column: "SchoolsID");
